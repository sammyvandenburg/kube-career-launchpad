    ...
    <footer className="bg-kubecraft-gray text-white py-12">
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">KubeCraft</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-300">
                <a href="https://www.skool.com/kubecraft" className="hover:text-white transition-colors">
                  www.skool.com/kubecraft
                </a>
              </li>
              <li className="text-gray-300">
                <a href="mailto:support@kubecraft.com" className="hover:text-white transition-colors">
